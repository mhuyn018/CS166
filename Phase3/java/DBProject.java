...
public class DBProject {
   ...
   public static void addRepair(DBProject esql){
      ...
      // ...
      try{
         String query = String.format("SELECT rID FROM Repair");
         ...
         System.out.print("Please enter maintenance company: ");
         String mCompany = in.readLine();
         System.out.print("Please enter repair date: ");
         String repairDate = in.readLine();
         System.out.print("Please enter repair description: ");
         String description = in.readLine();
         System.out.print("Please enter repair type: ");
         String repairType = in.readLine();

         query = String.format("INSERT INTO Repair (rID, hotelID, roomNo, mCompany, repairDate, description, repairType) VALUES (%d, '%s', '%s', '%s', '%s', '%s', '%s')", rID, hotelID, roomNo, mCompany, repairDate, description, repairType);
         esql.executeUpdate(query);

         query = String.format("SELECT r.* FROM Repair r WHERE rID = %d", rID);
   ...
   public static void bookRoom(DBProject esql){
      ...
      try {
         char bID[] = "0123456789".toCharArray();
         char letters[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ".toCharArray();
         char numbers[] = "0123456789".toCharArray();
         Random rand = new Random();
         for (int i = 0; i < 5; i++) {
            bID[i] = letters[rand.nextInt(26)];
         }
         for (int i = 6; i < 9; i++) {
            bID[i] = numbers[rand.nextInt(9)];
         }
         bID[9] = letters[rand.nextInt(26)];
         String book = new String(bID);
         ...
         String query = String.format("SELECT H.hotelID FROM Hotel H WHERE hotelID = ")

         query = String.format("INSERT INTO Booking (bID, customer, hotelID, roomNo, bookingDate, noOfPeople, price) VALUES (")
      }
   }//end bookRoom
   ...
   public static void numberOfAvailableRooms(DBProject esql){
      ...
      try {
         ...
         String query = String.format("SELECT R.roomNo, R.roomType, B.hotelID, COUNT(B), ")
      }
